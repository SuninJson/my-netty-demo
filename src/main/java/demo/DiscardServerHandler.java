...
public class DiscardServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        /*
         * To implement the DISCARD protocol, the demo.handler print message which is received.
         * ByteBuf is a reference-counted object which has to be released explicitly via the release() method.
         * Please keep in mind that it is the demo.handler's responsibility to release any reference-counted object passed to the demo.handler.
         */
        try {
